...
PKG_SUMMARY = "Binding to ORBit2 CORBA library"
PKG_SVN = "http://svn.maxidoors.ru/ruby-orbit"
...
file "ruby-orbit.cpp" do
  `cat lib/*.cpp > ruby-orbit.cpp`
end
...
#  rdoc.rdoc_files.include('TODO')
  ...
  rdoc.rdoc_files.include "ruby-orbit.cpp"
end
...
task :push_docs do
  user = "max_lapshin@ruby-orbit.rubyforge.org" 
  project = '/var/www/gforge-projects/ruby-orbit/doc'
  local_dir = 'doc'
  [ 
